        ...
        <div className = {HomePageStyle.pageContainer}>
            <div className = {HomePageStyle.contentContainer}>
                ...
                <main className={HomePageStyle.content}>
                    Welcome to my site! I'm a computer science student at Colorado State University and a software engineering intern at OHEL Technologies. A <Link to="/about" className={HomePageStyle.InParaLink}>tech nerd at heart</Link>, I love all things software, math, and machine learning. Some of my recent projects involve digital logic and legendary knights, <Link to="/projects" className={HomePageStyle.InParaLink}>check them out</Link>!
                </main>
